...
<form id="searchbar" method="get" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
	<div>
		...
		<a href="?<?php echo str_replace(array("&alt=on","&alt=off"),array("",""),$_SERVER["QUERY_STRING"])."&alt=".($Alt?"off":"on");?>" style="font-size: smaller; font-style: italic;">a small clicky link</a>
	</div>
</form>
